...
#define DEBUG_PRINT_ARRIVAL_IDS 1
#define DEBUG_PRINT_ROUTE 0
#define DEBUG_PACKETS_PER_SEC 10000
#define DEBUG_SIMULATION_START_TIME_IN_PICOSECS 30
#define DEBUG_SIMULATION_END_TIME_IN_SECS 40
